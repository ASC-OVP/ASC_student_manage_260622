...
const title: CSSProperties = { fontSize: 26, fontWeight: 950, margin: "0 0 4px" };
...
const primaryButton: CSSProperties = { background: "var(--asc-primary)", color: "#fff", border: "1px solid var(--asc-primary)", borderRadius: 8, padding: "9px 12px", fontWeight: 950, textDecoration: "none" };
const secondaryButton: CSSProperties = { background: "var(--asc-primary-soft)", color: "var(--asc-primary-hover)", border: "1px solid var(--asc-primary)", borderRadius: 8, padding: "9px 12px", fontWeight: 950, textDecoration: "none" };
