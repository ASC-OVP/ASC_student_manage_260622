      ...
      <section style={container}>
        <div style={header}>
          <div>
            ...
            <p style={desc}>{today} 기준 학생·반·업무·메모 운영 신호입니다.</p>
          </div>
...
const container: CSSProperties = { width: "100%", maxWidth: "none", margin: 0, display: "grid", gap: 16 };
const header: CSSProperties = { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 18 };
...
const stats: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(5, minmax(150px, 1fr))", gap: 12 };
const statCard: CSSProperties = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: 16, textDecoration: "none", color: "#111827", display: "flex", flexDirection: "column", gap: 8, minHeight: 112 };
...
const focusGrid: CSSProperties = { display: "grid", gridTemplateColumns: "minmax(0, 1.55fr) minmax(320px, 1fr)", gap: 14, alignItems: "stretch" };
const bottomGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 14 };
const panel: CSSProperties = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: 16, minHeight: 270, display: "flex", flexDirection: "column" };
...
const list: CSSProperties = { display: "flex", flexDirection: "column", gap: 8, flex: 1 };
...
const priorityItem: CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, padding: 12, border: "1px solid #e5e7eb", borderRadius: 8, color: "#111827", textDecoration: "none", background: "#f8fafc" };
const priorityBody: CSSProperties = { display: "flex", flexDirection: "column", gap: 4, minWidth: 0 };
const priorityAction: CSSProperties = { color: "#2563eb", fontSize: 12, fontWeight: 950, whiteSpace: "nowrap" };
const warnItem: CSSProperties = { background: "#fffbeb", borderColor: "#fde68a" };
const dangerItem: CSSProperties = { background: "#fef2f2", borderColor: "#fecaca" };
const taskItem: CSSProperties = { background: "#eff6ff", borderColor: "#bfdbfe" };
const compactCard: CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, border: "1px solid #f1f5f9", borderRadius: 8, padding: 11, color: "#111827", textDecoration: "none", background: "#f9fafb" };
...
const memoContent: CSSProperties = { color: "#374151", lineHeight: 1.35 };
const memoMeta: CSSProperties = { color: "#6b7280", fontWeight: 800 };
const statusTag: CSSProperties = { display: "inline-flex", alignItems: "center", height: 22, borderRadius: 999, background: "#f1f5f9", color: "#475569", padding: "0 8px", fontSize: 11, fontWeight: 950, whiteSpace: "nowrap" };
const warnTag: CSSProperties = { background: "#fef3c7", color: "#92400e" };
const dangerTag: CSSProperties = { background: "#fee2e2", color: "#991b1b" };
const taskTag: CSSProperties = { background: "#dbeafe", color: "#1d4ed8" };
const successTag: CSSProperties = { background: "#dcfce7", color: "#166534" };
...
const emptyBox: CSSProperties = { minHeight: 112, display: "grid", placeItems: "center", gap: 10, border: "1px dashed #d1d5db", borderRadius: 8, padding: 16, background: "#f9fafb", textAlign: "center" };
const emptyStyle: CSSProperties = { margin: 0, color: "#6b7280", fontWeight: 800 };
const smallGhostButton: CSSProperties = { border: "1px solid #d1d5db", borderRadius: 8, color: "#111827", background: "#fff", padding: "8px 10px", textDecoration: "none", fontWeight: 950 };
