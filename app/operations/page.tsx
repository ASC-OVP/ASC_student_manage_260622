  ...
  return (
    <main style={page}>
      <section style={container}>
        <div style={hero}>
          <div>
            <p style={eyebrow}>운영 점검</p>
            <h1 style={title}>운영 안정화</h1>
            <p style={desc}>
              운영중인 반, 미완료 업무, 검수 필요한 OMR, 내보내기, 최근 변경 기록을 한 화면에서 확인합니다.
            </p>
          </div>
          <div style={roleCard}>
            <span>현재 계정</span>
...
const statCard: CSSProperties = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: 14, display: "flex", flexDirection: "column", gap: 6 };
const warnCard: CSSProperties = { background: "#fffbeb", borderColor: "#fde68a" };
const dangerCard: CSSProperties = { background: "#fef2f2", borderColor: "#fecaca" };
const grid: CSSProperties = { display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 14 };
const panel: CSSProperties = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, padding: 18 };
const panelHead: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 12, marginBottom: 14 };
const panelTitle: CSSProperties = { margin: 0, fontSize: 18, fontWeight: 950 };
const panelDesc: CSSProperties = { margin: "5px 0 0", color: "#6b7280", fontSize: 13 };
const buttonRow: CSSProperties = { display: "flex", gap: 8, flexWrap: "wrap" };
const primaryButton: CSSProperties = { background: "#111827", color: "#fff", borderRadius: 8, padding: "10px 13px", textDecoration: "none", fontWeight: 950 };
const secondaryButton: CSSProperties = { background: "#fff", color: "#111827", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 13px", textDecoration: "none", fontWeight: 950 };
const disabledButton: CSSProperties = { ...secondaryButton, color: "#9ca3af", background: "#f9fafb" };
const hint: CSSProperties = { margin: "12px 0 0", color: "#6b7280", fontSize: 13 };
const shortcutGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 8 };
const shortcut: CSSProperties = { border: "1px solid #e5e7eb", borderRadius: 8, padding: "11px 12px", textDecoration: "none", color: "#111827", fontWeight: 900, background: "#f9fafb" };
const logTableWrap: CSSProperties = { overflow: "auto", border: "1px solid #e5e7eb", borderRadius: 8 };
