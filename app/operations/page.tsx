...
const title: CSSProperties = { margin: "4px 0", fontSize: 23, fontWeight: 950 };
const desc: CSSProperties = { margin: 0, color: "var(--asc-text-muted)", lineHeight: 1.45, fontSize: 13 };
const roleCard: CSSProperties = { minWidth: 168, border: "1px solid var(--asc-border)", borderRadius: "var(--asc-radius-lg)", padding: 10, display: "flex", flexDirection: "column", justifyContent: "center", gap: 4, background: "var(--asc-bg-subtle)" };
