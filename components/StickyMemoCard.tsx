...
import { deleteStickyMemoAction, updateStickyMemoAction } from "@/app/memos/actions";
import { getStickyMemoColorTheme, normalizeStickyMemoColor, stickyMemoColors } from "@/components/stickyMemoColors";
