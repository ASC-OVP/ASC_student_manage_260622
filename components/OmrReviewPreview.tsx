...
const openLink: CSSProperties = { ...toolButton, color: "#1d4ed8", textDecoration: "none" };
const viewport: CSSProperties = { height: 680, overflow: "auto", border: "1px solid #e5e7eb", borderRadius: 8, background: "#f9fafb" };
...
const emptyBox: CSSProperties = { border: "1px dashed #d1d5db", borderRadius: 8, padding: 28, textAlign: "center", color: "#6b7280", display: "grid", gap: 8 };
