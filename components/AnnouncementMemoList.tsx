...
const head: CSSProperties = { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 };
...
const pinnedGroup: CSSProperties = { display: "grid", gap: 8, border: "1px solid #fde68a", borderRadius: 9, padding: 9, background: "#fffbeb" };
const normalGroup: CSSProperties = { display: "grid", gap: 8 };
...
const card: CSSProperties = { border: "1px solid #e5e7eb", borderRadius: 8, padding: 11, background: "#fff", display: "grid", gap: 7 };
...
const content: CSSProperties = { margin: "6px 0 0", lineHeight: 1.45, color: "#374151", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden", whiteSpace: "normal" };
...
const summaryButton: CSSProperties = { cursor: "pointer", color: "#2563eb", fontWeight: 950, fontSize: 12 };
...
const empty: CSSProperties = { border: "1px dashed #d1d5db", borderRadius: 9, padding: 22, textAlign: "center", color: "#6b7280", fontWeight: 900, display: "grid", gap: 5, background: "#f8fafc" };
